...
/*!
 * @brief The bitwise operation code
 */
typedef enum bitwise_opt_code_s {
	BITWISE_AND = 0, /*!< (V0 & V1) --> V2 */
	BITWISE_AND_NOT_V0 = 1, /*!< (V0 & ~V1) --> V2 */
	BITWISE_AND_NOT_V1 = 2, /*!< (~V0 & V1) --> V2 */
	BITWISE_NOR = 3, /*!< ~(V0 | V1) --> V2 */
	BITWISE_OR = 4, /*!< (V0 | V1) --> V2 */
	BITWISE_OR_NOT_V0 = 5, /*!< (V0 | ~V1) --> V2 */
	BITWISE_OR_NOT_V1 = 6, /*!< (~V0 | V1) --> V2 */
	BITWISE_NAND = 7, /*!< ~(V0 & V1) --> V2 */
	BITWISE_XOR = 8, /*!< (V0 ^ V1) --> V2 */
	BITWISE_XNOR = 9, /*!< ~(V0 ^ V1) --> V2 */
	BITWISE_2SRC_LAST,
	BITWISE_2SRC_FIRST = BITWISE_AND,
} bitwise_opt_code_t;
...
/*!
 * @brief The maximal input size of vproc warp
 */
#ifndef CONFIG_ARCH_CV28
#define WARP_MAX_WIDTH_FX8 1920
#define WARP_MAX_HEIGHT_FX8 1080
#define WARP_MAX_WIDTH_FX16 1280
#define WARP_MAX_HEIGHT_FX16 800
#else
#define WARP_MAX_WIDTH_FX8 928
#define WARP_MAX_HEIGHT_FX8 540
#define WARP_MAX_WIDTH_FX16 640
#define WARP_MAX_HEIGHT_FX16 400
#endif
...
typedef struct vect_desc_s {
	cv_daddr_t data_addr; /*!< the start dram address that keeps the vector data */
	...
	uint32_t is_tenbit_packed : 1; /*!< indicate if vector is in 10bitpack format */
	uint32_t reserved_0 : 31; /*!< reserved field */
	uint32_t reserved[7]; /*!< reserved field */
} vect_desc_t;
...
typedef struct vect_desc_mfd_s {
	...
	cv_doffset_t data_addr_offset; /*!< the address offset based on memory fd where keeps vector data */
	uint32_t pitch; /*!< the pitch of the vector */
	vect_shape_t shape; /*!< the shape of the vector */
	data_format_t data_format; /*!< the data format of the vector */
	color_space_t color_space; /*!< the color space of the vector */
...
typedef struct deformation_extra_s {
	cv_rlt_offset_t uv_offset; /*!< the address offset based on Y data that keeps UV data */
...
typedef struct cvker_s{
	...
	cv_daddr_t mem_phy;  /*!<  kernel memory physical address */
	uint32_t reserved[8]; /*!< reserved field */
}cvker_t;
...
typedef struct cvker_mfd_s{
	...
	cv_doffset_t mem_addr_offset; /*!<  kernel memory address offset */
	uint32_t reserved[8]; /*!< reserved field */
}cvker_mfd_t;
...
typedef struct warpaffine_cfg_s {
	...
	cv_daddr_t wfld_mem_phys; /*!< the physical address of allocated memory where warp field data is kept */
...
typedef struct warpaffine_cfg_mfd_s {
	...
	cv_doffset_t wfld_mem_offset; /*!< the physical address offset of allocated memory where warp field data is kept */
	uint32_t wfld_mem_cache_en: 1; /*!< the flag to indicate if the allocated memory for warp field is cached */
	uint32_t inverse_mat: 1; /*!< the flag to indicate if the provided transformation matrix needs reversion */
	uint32_t reserved_0: 30; /*!< reserved field */
	uint32_t reserved[8]; /*!< reserved field */
...
typedef struct warppersp_cfg_s {
	...
	cv_daddr_t mat_mem_phys; /*!< the physical address of allocated memory for transformation matrix */
...
typedef struct warppersp_cfg_mfd_s {
	...
	cv_doffset_t mat_mem_offset; /*!< the physical address offset of allocated memory for transformation matrix */
	uint32_t mat_mem_cache_en: 1; /*!< the flag to indicate if the allocated memory for transformation matrix is cached */
	uint32_t inverse_mat: 1; /*!< the flag to indicate if the provided transformation matrix needs reversion */
	uint32_t reserved_0: 30; /*!< reserved field */
	uint32_t reserved[8]; /*!< reserved field */
...
/*!
* @brief The configuration for 2scales full-fov dsi fusion.
*/
typedef struct two_scales_ffov_cfg_s {
	IN float s0_invld_value; /*!<  invalid disparity value for scale0 DSI */
	IN float s2_invld_value; /*!<  invalid disparity value for scale2 DSI */
	OUT uint8_t integer_bit_cnt; /*!< integer bit count in output DSI */
	uint8_t reserved_0[3]; /*!< reserved field */
	uint32_t reserved[9]; /*!< reserved field */
} two_scales_ffov_cfg_t;

/*!
* @brief The configuration for dsi fusion scale0 with shifted mode.
*/
typedef struct s0_shifted_cfg_s {
	uint16_t shift; /*!< The amount of shift applied on left frame. Should be an integer between 0 and 127 */
	uint16_t reserved_0; /*!< reserved field */
	uint32_t reserved[7]; /*!< reserved field */
} s0_shifted_cfg_t;

/*!
* @brief The configuration for dsi fusion fused-scale0 with scale2 full-fov mode.
*/
typedef struct fs0_s2_ffov_cfg_s {
	uint16_t shift; /*!< The amount of shift applied on left frame. Should be an integer between 0 and 127 */
	uint16_t reserved_0; /*!< reserved field */
	uint32_t reserved[7]; /*!< reserved field */
} fs0_s2_ffov_cfg_t;
 ...
 * after it loads. It's suggest use vproc_warp_XXXX() instead of this funciton.
 *
 ...
 * It's suggest use vproc_warp_XXXX() instead of this funciton.
 *
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_memcpy(IN cv_daddr_t dst_phy_addr, IN cv_daddr_t src_phy_addr, IN uint32_t size);
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_memset(IN cv_daddr_t dst_phy_addr, IN uint8_t value, IN uint32_t size);
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int dsi_split_run(IN vect_desc_t *dsi_u16, IN cv_daddr_t dsi_split_mem,
 ...
 * The warp table must be generated by vproc_gen_warppersp_field().
 *
...
/*!
 * This extended API performs the DSI fusion on full FOV scale 0 and scale 2 disparity maps.
 * The input DSI can be in 10bitpacked format or 10.4 FX16 format.
 *
 * @param scale0_dsi Scale0's disparity map in 10bitpacked or 10.4 FX16 format
 * @param scale2_dsi Scale2's disparity map in 10bitpacked or 10.4 FX16 format
 * @param fused_dsi Output fused disparity map in either 8.4 format or 11.5 FX16 format
 * @param cfg Configuration for 2scales ffov DSI fusion
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_dsi_fusion_2scales_ffov_ext(vect_desc_t *scale0_dsi,
	vect_desc_t *scale2_dsi, vect_desc_t *fused_dsi, two_scales_ffov_cfg_t *cfg);

/*!
 * This API performs the DSI fusion on disparity map generated from scale0 left and right frames,
 * and disparity map generated from shifted left frame and scale0 right frame.
 *
 * @param scale0_dsi_packed10 Scale0's disparity map in 10bitpacked format
 * @param shifted_dsi_packed10 Disparity map in 10bitpacked format generated on shifted frames
 * @param fused_dsi Output fused disparity map in 8.4 format
 * @param cfg Configuration for DSI fusion scale0 with shifted mode
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_dsi_fusion_scale0_with_shifted(IN vect_desc_t *scale0_dsi_packed10,
	IN vect_desc_t *shifted_dsi_packed10, OUT vect_desc_t *fused_dsi,
	IN s0_shifted_cfg_t *cfg);

/*!
 * This API performs the DSI fusion on disparity map generated from scale0 left and right frames,
 * disparity map generated from shifted left frame and scale0 right frame, and disparity
 * map generated from scale2 left and right frames. The scale factor between scale0 and scale2
 * has to be 2.
 *
 * @param scale0_dsi_packed10 Scale0's disparity map in 10bitpacked format
 * @param shifted_dsi_packed10 Disparity map in 10bitpacked format generated on shifted frames
 * @param scale2_dsi_packed10 Scale2's disparity map in 10bitpacked format
 * @param fused_dsi Output fused disparity map in 8.4 format
 * @param cfg Configuration for DSI fusion fused-scale0 with scale2 full-fov mode
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_dsi_fusion_fscale0_with_scale2_ffov(IN vect_desc_t *scale0_dsi_packed10,
	IN vect_desc_t *shifted_dsi_packed10, IN vect_desc_t *scale2_dsi_packed10, OUT vect_desc_t *fused_dsi,
	IN fs0_s2_ffov_cfg_t *cfg);
...
/*!
 * This API performs the bitwise operation, e.g. and, or and nor for two vectors.
 *
 * @param src0 Input V0 vector
 * @param src1 Input V1 vector
 * @param dst Output vector after bitwise operation
 * @param bw_opt_code Bitwise operation code
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_bitwise(vect_desc_t *src0, vect_desc_t *src1,
	vect_desc_t *dst, uint32_t bw_opt_code);

/*! @} */ /* End of vproc-api-details */

/*!
 * @addtogroup vproc-api-details-mfd
 * @{
 */
 ...
 * is stored on the allocated memory with mfd.
 * It is suggest use vproc_warp_XXXX() instead of this funciton.
 *
 * @param handler Input processing handler
 * @param prj_mat_vect Input perspective projection matrix
 * @return 0 = success, -1 = error.
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_memcpy_mfd(IN int dst_mfd, IN cv_doffset_t dst_addr_offset,
	IN int src_mfd, IN cv_doffset_t src_addr_offset, IN uint32_t size);
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_memset_mfd(IN int dst_mfd, IN cv_doffset_t dst_addr_offset, IN uint8_t value, IN uint32_t size);
...
AMBA_API int dsi_split_run_mfd(IN vect_desc_mfd_t *dsi_u16, IN int dsi_split_mfd,
	IN cv_doffset_t dsi_split_moffset, IN void *dsi_split_virt,
 ...
 * stored on the allocated memory with mfd.
 * The warp table must be generated by vproc_gen_warppersp_field_mfd().
 *
 * @param src Input data vector in unsigned 8-bit format.
 * @param dst Output data vector in unsigned 8-bit format.
 * @param warp_fld Warp table in s11.4 format which is used to configure how the warp would be.
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_dsi_fusion_2scales_ffov_ext_mfd(vect_desc_mfd_t *scale0_dsi,
	vect_desc_mfd_t *scale2_dsi, vect_desc_mfd_t *fused_dsi, two_scales_ffov_cfg_t *cfg);
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_dsi_fusion_scale0_with_shifted_mfd(IN vect_desc_mfd_t *scale0_dsi_packed10,
	IN vect_desc_mfd_t *shifted_dsi_packed10, OUT vect_desc_mfd_t *fused_dsi,
	IN s0_shifted_cfg_t *cfg);
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_dsi_fusion_fscale0_with_scale2_ffov_mfd(IN vect_desc_mfd_t *scale0_dsi_packed10,
	IN vect_desc_mfd_t *shifted_dsi_packed10, IN vect_desc_t *scale2_dsi_packed10, OUT vect_desc_mfd_t *fused_dsi,
	IN fs0_s2_ffov_cfg_t *cfg);
 ...
 * @return 0 = success, -1 = error.
 */
AMBA_API int vproc_bitwise_mfd(vect_desc_mfd_t *src0, vect_desc_mfd_t *src1,
	vect_desc_mfd_t *dst, uint32_t bw_opt_code);

/*! @} */ /* End of vproc-api-details-mfd */

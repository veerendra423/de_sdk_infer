...
{
    L().info()<<"efficientdet Constructor "<< endl;
    custom_postprocess = NULL;
}

efficientdet :: ~efficientdet()
{
    L().info() << "efficientdet Destructor" << endl;
}

void efficientdet :: set_target_env(deie_detector *detobj, deie_hw_platform tgt, deie_device device)
{
...
void efficientdet :: set_target_input(deie_detector *detobj, deie_input_src input, deie_file_input *path)
{   
    switch (input)
    {           
...
//for camera input
void efficientdet :: set_target_input(deie_detector *detobj, deie_input_src input, int devicefd) 
{
    switch(input)
    {
...
void efficientdet :: set_model_info (deie_detector *detobj, deie_detector_model model)
{
...
void efficientdet :: set_input_pre_processing(deie_detector *detobj, deie_detector_input_preproc preproc, deie_input_color_format cfmt)
{

}
void efficientdet :: set_input_pre_processing(deie_detector *detobj, deie_detector_input_preproc preproc, void *value)
{

}

void efficientdet :: set_output_buffer(deie_detector *detobj, void *ptr, int size)
{

}
void efficientdet :: set_output_params(deie_detector *detobj, deie_detector_output_params outparams, int value)
{

}

void efficientdet :: allocate_io_buffer(deie_detector *detobj, deie_io_desc *ioptr)
{
...
void efficientdet :: free_io_buffer(deie_detector *detobj, deie_io_desc *ioptr)
{
    //free(ioptr);
}

void efficientdet :: set_model_input_buffers(deie_detector *detobj, int num, void** ptr)
{

}

void efficientdet :: set_model_output_buffers(deie_detector *detobj, int num, void** ptr)
{

}

void efficientdet :: register_custom_pre_processor(deie_detector *detobj, deie_detector_preprocessor preprocessor)
{

}

void efficientdet :: register_custom_post_processor(deie_detector *detobj, deie_detector_postprocessor postprocessor)
{
    if (detobj == this)
        custom_postprocess = postprocessor;
}

void efficientdet :: intel_nuc_post_process(void *, int num_outputs, deie_detector_model* out)
{   
    auto start = high_resolution_clock::now();
    L().info()<<"intel post processing at efficientdet"<<endl;
    // for(int i=0; i<num_outputs; i++)
    // {
...
void efficientdet :: run_inference(deie_detector *detobj, deie_detector_process_results inference_out)
{
    L().info() << "run inference at efficientdet info";
    int x = num_outputs;
...
void efficientdet :: stop_inference(deie_detector *detobj)
{
    delete detobj;
}
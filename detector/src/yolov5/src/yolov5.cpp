...
Yolov5 :: Yolov5()
{
    L().info()<<"YOLOV5 Constructor "<< endl;
    custom_postprocess = NULL;
}

Yolov5 :: ~Yolov5()
{
    L().info() << "YOLOV5 Destructor" << endl;
}

void Yolov5 :: set_target_env(deie_detector *detobj, deie_hw_platform tgt, deie_device device)
{
...
void Yolov5 :: set_target_input(deie_detector *detobj, deie_input_src input, deie_file_input *path)
{   
    switch (input)
    {           
...
//for camera input
void Yolov5 :: set_target_input(deie_detector *detobj, deie_input_src input, int devicefd) 
{
    switch(input)
    {
...
void Yolov5 :: set_model_info (deie_detector *detobj, deie_detector_model model)
{
...
void Yolov5 :: set_input_pre_processing(deie_detector *detobj, deie_detector_input_preproc preproc, deie_input_color_format cfmt)
{

}
void Yolov5 :: set_input_pre_processing(deie_detector *detobj, deie_detector_input_preproc preproc, void *value)
{

}

void Yolov5 :: set_output_buffer(deie_detector *detobj, void *ptr, int size)
{

}
void Yolov5 :: set_output_params(deie_detector *detobj, deie_detector_output_params outparams, int value)
{

}

void Yolov5 :: allocate_io_buffer(deie_detector *detobj, deie_io_desc *ioptr)
{
...
void Yolov5 :: free_io_buffer(deie_detector *detobj, deie_io_desc *ioptr)
{
    //free(ioptr);
}

void Yolov5 :: set_model_input_buffers(deie_detector *detobj, int num, void** ptr)
{

}

void Yolov5 :: set_model_output_buffers(deie_detector *detobj, int num, void** ptr)
{

}

void Yolov5 :: register_custom_pre_processor(deie_detector *detobj, deie_detector_preprocessor preprocessor)
{

}

void Yolov5 :: register_custom_post_processor(deie_detector *detobj, deie_detector_postprocessor postprocessor)
{
    if (detobj == this)
        custom_postprocess = postprocessor;
}

void Yolov5 :: intel_nuc_post_process(void *, int num_outputs, deie_detector_model* out)
{   
    auto start = high_resolution_clock::now();
    L().info()<<"intel post processing at yolov5"<<endl;
    // for(int i=0; i<num_outputs; i++)
    // {
...
void Yolov5 :: run_inference(deie_detector *detobj, deie_detector_process_results inference_out)
{
    L().info() << "run inference at yolov5 info";
    int x = num_outputs;
...
void Yolov5 :: stop_inference(deie_detector *detobj)
{
    delete detobj;
}
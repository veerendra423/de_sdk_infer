...
Yolov4 :: Yolov4()
{
    L().info()<<"YOLOV4 Constructor "<< endl;
    custom_postprocess = NULL;
}

Yolov4 :: ~Yolov4()
{
    L().info() << "YOLOV4 Destructor" << endl;
}

void Yolov4 :: set_target_env(deie_detector *detobj, deie_hw_platform tgt, deie_device device)
{
...
void Yolov4 :: set_target_input(deie_detector *detobj, deie_input_src input, deie_file_input *path)
{   
    switch (input)
    {           
...
//for camera input
void Yolov4 :: set_target_input(deie_detector *detobj, deie_input_src input, int devicefd) 
{
    switch(input)
    {
...
void Yolov4 :: set_model_info (deie_detector *detobj, deie_detector_model model)
{
...
void Yolov4 :: set_input_pre_processing(deie_detector *detobj, deie_detector_input_preproc preproc, deie_input_color_format cfmt)
{

}
void Yolov4 :: set_input_pre_processing(deie_detector *detobj, deie_detector_input_preproc preproc, void *value)
{

}

void Yolov4 :: set_output_buffer(deie_detector *detobj, void *ptr, int size)
{

}
void Yolov4 :: set_output_params(deie_detector *detobj, deie_detector_output_params outparams, int value)
{

}

void Yolov4 :: allocate_io_buffer(deie_detector *detobj, deie_io_desc *ioptr)
{
...
void Yolov4 :: free_io_buffer(deie_detector *detobj, deie_io_desc *ioptr)
{
    //free(ioptr);
}

void Yolov4 :: set_model_input_buffers(deie_detector *detobj, int num, void** ptr)
{

}

void Yolov4 :: set_model_output_buffers(deie_detector *detobj, int num, void** ptr)
{

}

void Yolov4 :: register_custom_pre_processor(deie_detector *detobj, deie_detector_preprocessor preprocessor)
{

}

void Yolov4 :: register_custom_post_processor(deie_detector *detobj, deie_detector_postprocessor postprocessor)
{
    if (detobj == this)
        custom_postprocess = postprocessor;
}

void Yolov4 :: intel_nuc_post_process(void *, int num_outputs, deie_detector_model* out)
{   
    auto start = high_resolution_clock::now();
    L().info()<<"intel post processing at yolov4"<<endl;
    // for(int i=0; i<num_outputs; i++)
    // {
...
void Yolov4 :: run_inference(deie_detector *detobj, deie_detector_process_results inference_out)
{
    L().info() << "run inference at yolov4 info";
    int x = num_outputs;
...
void Yolov4 :: stop_inference(deie_detector *detobj)
{
    delete detobj;
}